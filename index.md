...
```
## Error in setwd("/Users/monoxide2000/Desktop/slidesMetodos_parte1/"): cannot change working directory
```
...
```
## [1] "/Users/monoxide2000/Desktop/exampleSlide"
```
...
```
## Error in dim(vec) <- c(4, 4): dims [product 16] do not match the length of object [10]
```
